...
const pedidosEjemplo = [
  { id: 8, mesa: "Mesa 8", cliente: "Ana", estado: "Pendiente", hora: "20:00",
    items: [{ nombre: "CEVICHE MIXTO", precio: 16.5 }, { nombre: "LECHE DE TIGRE", precio: 9.0 }] },
  { id: 5, mesa: "Mesa 5", cliente: "Juan", estado: "Pendiente", hora: "19:30",
    items: [{ nombre: "PARIHUELA", precio: 24.5 }, { nombre: "LANGOSTINOS", precio: 12.5 }] },
  { id: 3, mesa: "Mesa 3", cliente: "Carlos", estado: "Pendiente", hora: "19:45",
    items: [{ nombre: "CHILCANO", precio: 20.0 }] },
  { id: 12, mesa: "Mesa 12", cliente: "María", estado: "Pendiente", hora: "19:15",
...
export default function Pedidos_Fisicos() {
  ...
  const actualizarEstado = (id) => {
    setPedidos((prev) =>
      prev.map((p) =>
        p.id === id ? { ...p, estado: "En preparación" } : p
      )
    );
  };
