...
const pedidosEjemplo = [
  { id: 8, mesa: "Mesa 8", cliente: "Ana Martínez", estado: "Pendiente", hora: "20:00",
    items: [{ nombre: "Hamburguesa Clásica", precio: 16.5 }, { nombre: "Papas Fritas", precio: 8.0 }] },
  { id: 5, mesa: "Mesa 5", cliente: "Juan Pérez", estado: "En preparación", hora: "19:30",
    items: [{ nombre: "Pizza Margherita", precio: 24.5 }, { nombre: "Ensalada César", precio: 12.5 }] },
  { id: 3, mesa: "Mesa 3", cliente: "Carlos López", estado: "Listo", hora: "19:45",
    items: [{ nombre: "Salmón Grillado", precio: 32.0 }] },
  { id: 12, mesa: "Mesa 12", cliente: "María García", estado: "Servido", hora: "19:15",
    items: [{ nombre: "Pasta Carbonara", precio: 36.0 }, { nombre: "Vino Tinto", precio: 15.0 }] },
];
